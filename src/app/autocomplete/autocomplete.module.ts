...
import { AutocompleteDoubleComponent } from './autocomplete-double/autocomplete-double.component';
...
@NgModule({
  ...
  declarations: [AutocompleteIndexComponent, AutocompleteExampleComponent, AutocompleteExamplesComponent, AutocompleteDoubleComponent],
})
