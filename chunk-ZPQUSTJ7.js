...
}`]],template:function(i,r){i&1&&m(0,"it-chips-example")(1,"it-source-display",0)(2,"it-chips-colors")(3,"it-source-display",1)(4,"it-chips-disabled")(5,"it-source-display",2)(6,"it-chips-group")(7,"it-source-display",3)},dependencies:[G,D,N,R,F]});let e=t;return e})();var P=(()=>{let t=class t{constructor(){this.component=L.components.find(a=>a.name==="ItChipComponent")}};t.\u0275fac=function(i){return new(i||t)},t.\u0275cmp=b({type:t,selectors:[["it-chip-index"]],decls:10,vars:2,consts:[[1,"bd-title"],[1,"bd-lead"],[3,"innerHTML"],["label","Esempi","active","true",1,"mt-3"],["label","API",1,"mt-3"],[3,"component"]],template:function(i,r){i&1&&(o(0,"h1",0),h(1,"Chips"),n(),o(2,"p",1),h(3,"Elementi compatti che rappresentano un input, attributo o azione."),n(),m(4,"div",2),o(5,"it-tab-container")(6,"it-tab-item",3),m(7,"it-chips-examples"),n(),o(8,"it-tab-item",4),m(9,"it-api-parameters",5),n()()),i&2&&(c(4),l("innerHTML",r.component.description,I),c(5),l("component",r.component))},dependencies:[B,T,V,k],encapsulation:2});let e=t;return e})();var re=[{path:"",component:P}],U=(()=>{let t=class t{};t.\u0275fac=function(i){return new(i||t)},t.\u0275mod=w({type:t}),t.\u0275inj=x({imports:[z.forChild(re),z]});let e=t;return e})();var Me=(()=>{let t=class t{};t.\u0275fac=function(i){return new(i||t)},t.\u0275mod=w({type:t}),t.\u0275inj=x({imports:[S,A,M,U]});let e=t;return e})();export{Me as ChipModule};
